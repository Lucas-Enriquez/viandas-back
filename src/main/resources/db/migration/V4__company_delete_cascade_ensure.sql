-- Idempotente: garantiza que cada FK afectada por el delete de companies tenga
-- ON DELETE CASCADE, sin importar el estado heredado de V1/V2/V3.
-- Dropea por los dos nombres posibles y crea con el nombre que Hibernate espera.
